    ...
    <main className="bg-[#fdf6f9] min-h-screen">
      ...
      <section className="px-12 py-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { img: dma, nombre: 'Desayuno Mujer Arco', desc: 'Plato fuerte + mini pastel + frutas + jugo o caffe lato + frutos secos + snack dulce + yogurt con granola + tarjeta o foto', precio: '$20.00' },
            ...
            <div key={i} className="bg-white rounded-2xl border border-pink-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 duration-300 transition">
              ...
              />
              <div className="p-5">
                <p className="font-semibold text-gray-700 text-lg">{item.nombre}</p>
      ...
      <section className="px-12 py-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { img: fb, nombre: 'Arreglo de Fresas', desc: 'Fresas con chocolate + tarjeta o foto', precio: '$20.00' },
